...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5/BigTreeTech SKR Mini E3 V3.0 (TMC2209)"

//#define E3D           // Enable for the E3D all metal hotend.
#define E3D_Extreme     // Enable to print at over 285°C. Strongly discouraged by E3D but needed briefly. They say a little over isn't too risky but should not be done long term.
...
#define SKR_MINI_E3_V3_0 // Enable for the SKR Mini E3 V3.0.
...
#define STRING_CONFIG_H_AUTHOR "(mribeiro, Ender-5)" // Who made the changes.
 ...
 */
#if ENABLED(E3D) || ENABLED(E3D_Extreme)
  #define TEMP_SENSOR_0 5   // ATC Semitec 104GT-2 used in E3D hotends (required for temps above ~300°C)
#else
  #define TEMP_SENSOR_0 1   // 100k EPCOS thermistor
#endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.34, 79.89, 802.81, 96.88 }
...
// Per-side margins (override PROBING_MARGIN on individual sides).
// Probe is 46mm to the LEFT (+X) of the nozzle on Ender-5 (X=0 at right home, X=220 at left).
// PROBING_MARGIN_RIGHT limits how close the probe gets to X_MAX_BED (physical left side).
// _max_x() = MIN(220 - PROBING_MARGIN_RIGHT, 220 + 46) = 220 - 46 = 174 → nozzle at 128mm.
